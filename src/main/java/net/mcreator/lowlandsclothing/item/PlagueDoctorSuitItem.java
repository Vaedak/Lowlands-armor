...
public abstract class PlagueDoctorSuitItem extends ArmorItem {
	...
	public static void registerArmorMaterial(RegisterEvent event) {
		event.register(Registries.ARMOR_MATERIAL, registerHelper -> {
			...
			}), 9, DeferredHolder.create(Registries.SOUND_EVENT, ResourceLocation.parse("block.bamboo.hit")), () -> Ingredient.of(new ItemStack(Items.LEATHER)),
					List.of(new ArmorMaterial.Layer(ResourceLocation.parse("lowlands_clothing:plaguedoctor"))), 0f, 0f);
			registerHelper.register(ResourceLocation.parse("lowlands_clothing:plague_doctor_suit"), armorMaterial);
	...
	public static void registerItemExtensions(RegisterClientExtensionsEvent event) {
		...
		}, LowlandsClothingModItems.PLAGUE_DOCTOR_SUIT_HELMET.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
				HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("body", new ModelPlaguedoctor_v01(Minecraft.getInstance().getEntityModels().bakeLayer(ModelPlaguedoctor_v01.LAYER_LOCATION)).Body, "left_arm",
						new ModelPlaguedoctor_v01(Minecraft.getInstance().getEntityModels().bakeLayer(ModelPlaguedoctor_v01.LAYER_LOCATION)).LeftArm, "right_arm",
		...
		}, LowlandsClothingModItems.PLAGUE_DOCTOR_SUIT_CHESTPLATE.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
		...
		}, LowlandsClothingModItems.PLAGUE_DOCTOR_SUIT_LEGGINGS.get());
		event.registerItem(new IClientItemExtensions() {
			@Override
			@OnlyIn(Dist.CLIENT)
			public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
		...
		}, LowlandsClothingModItems.PLAGUE_DOCTOR_SUIT_BOOTS.get());
	}

	public PlagueDoctorSuitItem(ArmorItem.Type type, Item.Properties properties) {
		super(ARMOR_MATERIAL, type, properties);
	}

	public static class Helmet extends PlagueDoctorSuitItem {
		public Helmet() {
			super(ArmorItem.Type.HELMET, new Item.Properties().durability(ArmorItem.Type.HELMET.getDurability(12)));
		}
	}

	public static class Chestplate extends PlagueDoctorSuitItem {
		public Chestplate() {
		...
		public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
			...
			if (entity instanceof Player player && Iterables.contains(player.getArmorSlots(), itemstack)) {
				PlagueDoctorSuittickupdateProcedure.execute(entity);
			}
		}
	}

	public static class Leggings extends PlagueDoctorSuitItem {
		public Leggings() {
			super(ArmorItem.Type.LEGGINGS, new Item.Properties().durability(ArmorItem.Type.LEGGINGS.getDurability(12)));
		}
	}

	public static class Boots extends PlagueDoctorSuitItem {
		public Boots() {
