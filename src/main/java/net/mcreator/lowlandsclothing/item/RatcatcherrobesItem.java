...
public abstract class RatcatcherrobesItem extends ArmorItem {
	...
	public static class Helmet extends RatcatcherrobesItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "lowlands_clothing:textures/models/armor/ratcatcherc01_layer_1.png";
		}
	}
	...
	public static class Chestplate extends RatcatcherrobesItem {
		...
		public void initializeClient(Consumer<IClientItemExtensions> consumer) {
			consumer.accept(new IClientItemExtensions() {
				...
				@OnlyIn(Dist.CLIENT)
				public HumanoidModel getHumanoidArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("body", new Modelratcatcher_armor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelratcatcher_armor.LAYER_LOCATION)).Body,
							"left_arm", new Modelratcatcher_armor(Minecraft.getInstance().getEntityModels().bakeLayer(Modelratcatcher_armor.LAYER_LOCATION)).LeftArm, "right_arm",
	...
	public static class Leggings extends RatcatcherrobesItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "lowlands_clothing:textures/models/armor/ratcatcherc01_layer_2.png";
		}
	}
