...
import net.mcreator.lowlandsclothing.client.model.ModelSiegeArmorv3;
import net.mcreator.lowlandsclothing.client.model.ModelSiegeArmorv2;
import net.mcreator.lowlandsclothing.client.model.ModelSiegeArmor;
...
import net.mcreator.lowlandsclothing.client.model.ModelGateSentryv3corre01;
import net.mcreator.lowlandsclothing.client.model.ModelGateSentryv3cor;
import net.mcreator.lowlandsclothing.client.model.ModelGamekeeperarmor;
...
public class LowlandsClothingModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(ModelSiegeArmorv2.LAYER_LOCATION, ModelSiegeArmorv2::createBodyLayer);
		event.registerLayerDefinition(ModelHellborn_Pirate.LAYER_LOCATION, ModelHellborn_Pirate::createBodyLayer);
		...
		event.registerLayerDefinition(ModelGateSentryv3cor.LAYER_LOCATION, ModelGateSentryv3cor::createBodyLayer);
		...
		event.registerLayerDefinition(ModelGatekeeper_corrected.LAYER_LOCATION, ModelGatekeeper_corrected::createBodyLayer);
		event.registerLayerDefinition(ModelPenitant_Outfit.LAYER_LOCATION, ModelPenitant_Outfit::createBodyLayer);
		event.registerLayerDefinition(ModelSiegeArmorv4.LAYER_LOCATION, ModelSiegeArmorv4::createBodyLayer);
		...
		event.registerLayerDefinition(ModelSwampfolk_attires.LAYER_LOCATION, ModelSwampfolk_attires::createBodyLayer);
		...
		event.registerLayerDefinition(ModelGateSentryv3corre01.LAYER_LOCATION, ModelGateSentryv3corre01::createBodyLayer);
		...
		event.registerLayerDefinition(ModelGamekeeperarmor.LAYER_LOCATION, ModelGamekeeperarmor::createBodyLayer);
		event.registerLayerDefinition(ModelSiegeArmor.LAYER_LOCATION, ModelSiegeArmor::createBodyLayer);
		event.registerLayerDefinition(ModelSiegeArmorv3.LAYER_LOCATION, ModelSiegeArmorv3::createBodyLayer);
