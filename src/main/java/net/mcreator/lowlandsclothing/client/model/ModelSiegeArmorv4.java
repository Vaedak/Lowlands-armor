...
public class ModelSiegeArmorv4<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("lowlands_clothing", "model_siege_armorv_4"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 53).addBox(-3.7F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.95F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
		PartDefinition RightArm_r1 = RightArm.addOrReplaceChild("RightArm_r1",
				CubeListBuilder.create().texOffs(16, 51).addBox(-7.75F, -6.0F, 0.0167F, 12.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(32, 62).addBox(-0.75F, -2.0F, -2.5167F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.7F)),
				PartPose.offsetAndRotation(-4.0749F, -1.9652F, 0.05F, 0.0F, 0.0F, 0.2182F));
		PartDefinition RightArm_r2 = RightArm.addOrReplaceChild("RightArm_r2", CubeListBuilder.create().texOffs(70, 15).addBox(-0.5F, -3.0F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.7F)),
				PartPose.offsetAndRotation(-3.9889F, 8.4F, 0.0333F, 0.0F, 0.0F, -0.4363F));
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(60, 51).addBox(-0.3F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.95F)), PartPose.offset(5.0F, 2.0F, 0.0F));
		PartDefinition LeftArm_r1 = LeftArm.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(52, 67).addBox(-4.25F, -2.0F, -2.5167F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.7F)).texOffs(32, 0).addBox(-4.25F, -6.0F, 0.0167F, 12.0F, 10.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.0749F, -1.9652F, 0.05F, 0.0F, 0.0F, -0.2182F));
		PartDefinition LeftArm_r2 = LeftArm.addOrReplaceChild("LeftArm_r2", CubeListBuilder.create().texOffs(72, 67).addBox(-2.5F, -3.0F, -2.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.7F)),
				PartPose.offsetAndRotation(3.9889F, 8.4F, 0.0333F, 0.0F, 0.0F, 0.4363F));
