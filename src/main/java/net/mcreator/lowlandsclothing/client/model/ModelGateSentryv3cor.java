...
public class ModelGateSentryv3cor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("lowlands_clothing", "model_gate_sentryv_3cor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(32, 36).addBox(-4.5528F, -9.7917F, -0.8569F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.65F)).texOffs(32, 15).addBox(-4.5528F, -9.614F, -0.8569F, 8.0F, 17.0F, 4.0F, new CubeDeformation(1.0F)),
