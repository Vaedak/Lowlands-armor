...
public class ModelNorsian_armor_corected<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("lowlands_clothing", "model_norsian_armor_corected"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(60, 73).mirror().addBox(-2.1778F, 6.0F, -2.3556F, 5.0F, 2.0F, 5.0F, new CubeDeformation(0.435F)).mirror(false).texOffs(16, 38).mirror()
				.addBox(-1.6444F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.43F)).mirror(false), PartPose.offset(1.9F, 12.0F, 0.0F));
