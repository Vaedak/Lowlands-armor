...
public class Modelmaskerade_armor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "maskerade_armor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(62, 24)
						.addBox(-1.0F, -3.0F, -5.8222F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(28, 0)
						.addBox(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition head4 = head
				.addOrReplaceChild("head4",
						CubeListBuilder.create().texOffs(22, 52).addBox(0.6428F, -8.0F, 0.3389F, 5.0F, 8.0F, 6.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-8.0F, 0.0F, 0.0F, 0.0F, 0.829F, 0.0F));

		PartDefinition head3 = head
				.addOrReplaceChild("head3",
						CubeListBuilder.create().texOffs(0, 48).addBox(-5.6428F, -8.0F, 0.3389F, 5.0F, 8.0F, 6.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(8.0F, 0.0F, 0.0F, 0.0F, -0.829F, 0.0F));

		PartDefinition nose3 = head
				.addOrReplaceChild("nose3",
						CubeListBuilder.create().texOffs(32, 66).addBox(-5.6428F, -1.0F, -1.6611F, 2.0F, 4.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(8.0F, -2.0F, 0.0F, 0.0F, -0.829F, 0.0F));

		PartDefinition nose4 = head
				.addOrReplaceChild("nose4",
						CubeListBuilder.create().texOffs(70, 24).addBox(3.6428F, -1.0F, -1.6611F, 2.0F, 4.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-8.0F, -2.0F, 0.0F, 0.0F, 0.829F, 0.0F));
		...
		PartDefinition arms_left = partdefinition.addOrReplaceChild("arms_left",
				CubeListBuilder.create().texOffs(60, 58)
						.addBox(4.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)).texOffs(16, 66)
						.addBox(8.0F, 2.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 2.0F, 0.0F));

		PartDefinition arm_right = partdefinition.addOrReplaceChild("arm_right",
				CubeListBuilder.create().texOffs(0, 62)
						.addBox(1.0F, -31.0F, -7.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)).texOffs(24, 66)
						.addBox(-1.0F, -27.0F, -6.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
