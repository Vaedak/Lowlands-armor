...
public class ModelBret_armor_corsair_v2<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bret_armor_corsair_v2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(44, 41).addBox(
				-4.0F, -9.0F, -4.0F, 8.0F, 9.0F, 8.0F, new CubeDeformation(0.6F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(44, 58).addBox(-10.5F, -1.0F, 0.0F, 21.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0333F, -4.7651F, 6.9047F, -0.5672F, 0.0F, 0.0F));

		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 43).addBox(0.0F, -1.0F, -10.0F, 0.0F, 2.0F, 22.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -6.6918F, -3.2778F, 0.1376F, -0.5335F, -0.558F));

		PartDefinition cube_r3 = Head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 19).addBox(0.0F, -1.0F, -10.0F, 0.0F, 2.0F, 22.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, -6.6918F, -3.2778F, 0.1376F, 0.5335F, 0.558F));
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(44, 60)
						.addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.6F)).texOffs(0, 67)
						.addBox(-4.0F, 0.3556F, -2.0F, 8.0F, 10.0F, 4.0F, new CubeDeformation(1.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Body_r1 = Body.addOrReplaceChild("Body_r1",
				CubeListBuilder.create().texOffs(44, 19).addBox(-6.0F, -8.0F, -3.0F, 12.0F, 16.0F, 6.0F,
						new CubeDeformation(1.0F)),
				PartPose.offsetAndRotation(-3.0667F, 8.1778F, 0.3556F, 0.0F, 0.0F, 0.0873F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(40, 76)
				.addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.4F)),
				PartPose.offset(-5.0F, 2.0F, 0.0F));

		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(76, 41)
				.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 10.0F, 4.0F, new CubeDeformation(0.4F)),
				PartPose.offset(5.0F, 2.0F, 0.0F));

		PartDefinition cube_r5 = LeftArm.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(56, 76).addBox(-1.0F, -4.0F, -2.0F, 0.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(4.4667F, 6.0F, 0.0F, 0.0F, 0.0F, 0.0873F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(24, 67)
		...
		PartDefinition cube_r6 = RightLeg.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(64, 76).addBox(-3.0F, -2.0F, -1.0F, 5.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.0F, -1.5778F, 0.48F, 0.0F, 0.0F));

		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(68, 60)
		...
		PartDefinition cube_r7 = LeftLeg.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(76, 55).addBox(-2.0F, -2.0F, -1.0F, 5.0F, 2.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.0F, -1.5778F, 0.48F, 0.0F, 0.0F));
