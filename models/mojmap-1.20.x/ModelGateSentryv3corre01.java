...
public class ModelGateSentryv3corre01<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "gatesentryv3corre01"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition
				.addOrReplaceChild("Head",
						CubeListBuilder.create().texOffs(0, 15).addBox(-4.0F, -8.1778F, -4.0F, 8.0F, 8.0F, 8.0F,
		...
		PartDefinition Head_r2 = Head.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(0, 31).addBox(-4.0F, -32.0F, -4.0F, 8.0F, 8.0F, 8.0F,
						new CubeDeformation(1.2F)),
				PartPose.offsetAndRotation(0.0F, 23.8222F, 0.0F, 0.0F, 3.1416F, 0.0F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(32, 36).addBox(-4.5528F, -9.7917F, -0.8569F, 8.0F, 12.0F, 4.0F,
		...
		PartDefinition Body_r3 = Body.addOrReplaceChild("Body_r3",
				CubeListBuilder.create().texOffs(32, 15).addBox(-4.0F, -8.5F, -2.0F, 8.0F, 17.0F, 4.0F,
