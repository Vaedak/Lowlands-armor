...
public class Modelratcatcher_armor<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "ratcatcher_armor"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 15).addBox(
				-4.0F, -14.0F, -4.0F, 8.0F, 14.0F, 8.0F, new CubeDeformation(0.4F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 53).addBox(-1.0F, -4.0F, -4.0F, 0.0F, 6.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.3556F, -3.4F, -1.2889F, 0.0165F, 0.0004F, -0.004F));

		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(32, 15).addBox(-4.5F, -2.0F, -5.0F, 10.0F, 2.0F, 10.0F,
						new CubeDeformation(0.4F)),
				PartPose.offsetAndRotation(-0.5F, -6.0F, 0.0F, 0.0F, 0.0F, -0.0873F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(32, 27).addBox(
				-4.0F, 0.0F, -2.0F, 8.0F, 18.0F, 4.0F, new CubeDeformation(0.8F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(22, 52).addBox(-1.0F, -4.0F, -4.0F, 0.0F, 5.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 13.8889F, -3.0F, 0.0867F, 0.5597F, 0.2046F));

		PartDefinition cube_r3 = Body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(11, 63).addBox(-1.0F, -4.0F, -4.0F, 0.0F, 5.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = Body.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(12, 70).addBox(-1.0F, -4.0F, -4.0F, 0.0F, 5.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = Body.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(56, 27).addBox(-1.0F, -4.0F, -4.0F, 0.0F, 5.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = Body.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(56, 37).addBox(-1.0F, -4.0F, -4.0F, 0.0F, 5.0F, 5.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0667F, 14.8444F, -1.2889F, 0.4745F, -0.9858F, -0.1884F));

		PartDefinition Head_r2 = Body
				.addOrReplaceChild("Head_r2",
						CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -1.5F, -6.0F, 12.0F, 3.0F, 12.0F,
								new CubeDeformation(0.4F)),
						PartPose.offsetAndRotation(0.0F, 0.5F, 0.0F, 0.0436F, 0.0F, 0.0F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(48, 0)
						.addBox(-3.4667F, 8.0F, -2.4667F, 5.0F, 1.0F, 5.0F, new CubeDeformation(0.5F)).texOffs(48, 49)
		...
		PartDefinition RightArm_r1 = RightArm.addOrReplaceChild("RightArm_r1",
				CubeListBuilder.create().texOffs(65, 47).addBox(-1.5F, -6.0F, 0.5F, 4.0F, 12.0F, -1.0F,
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(0, 37)
						.addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F)).texOffs(48, 6)
		...
		PartDefinition LeftArm_r1 = LeftArm.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(22, 63).addBox(-2.5F, -6.0F, 0.5F, 4.0F, 12.0F, -1.0F,
						new CubeDeformation(0.5F)),
				PartPose.offsetAndRotation(4.1444F, 4.0F, 0.3556F, 0.0894F, -0.3829F, -0.2355F));

		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(16, 37)
				.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.43F)),
				PartPose.offset(-1.9F, 12.0F, 0.0F));

		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(32, 49)
